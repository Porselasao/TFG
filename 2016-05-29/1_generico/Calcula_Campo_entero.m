function [ Etot,Ptot,directivity_dBi,Thmax,Phmax,directivity_dBi_buscada] = Calcula_Campo_entero( array_config,freq_config,range_config,deltheta,delphi,thetabuscado,phibuscado )
%
