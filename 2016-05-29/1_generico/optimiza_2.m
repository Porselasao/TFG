function [array_config]=optimiza_2(Potencia_sensores,freq_config,Numero_de_sensores,posicion_X,posicion_Y,posicion_Z,range_config,thetabuscado,phibuscado,array_config,generaciones,poblacion,clusters_fijados)
