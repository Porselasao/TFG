...
for i=1:(tiempo_de_simulacion)
    ...
    hold on
%     polar(t,[Etot{antenas,sensor,phi,theta,instante,1}(vector_thetas(theta),1) Etot{antenas,sensor,phi,theta,instante,1}(vector_thetas(theta),:)],LineSpec);
    polar(t(1:end),[Etot1{c_antenas,c_sensor,c_phi,c_theta,i,1}(vector_thetas(c_theta)+1,:) Etot1{c_antenas,c_sensor,c_phi,c_theta,i,1}(vector_thetas(c_theta)+1,1)],LineSpec);
    %     plot(t(1:72),[Etot{antenas,sensor,phi,theta}(18,:,i)])
    hold off
    title([titulo caso])
    pause
...
figure
for i=1:(tiempo_de_simulacion)
    plot(t,[Etot1{c_antenas,c_sensor,c_phi,c_theta,i,1}(vector_thetas(c_theta)+1,:) Etot1{c_antenas,c_sensor,c_phi,c_theta,i,1}(vector_thetas(c_theta)+1,1)])
    pause
end
end
