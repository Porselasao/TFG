...
% cd resultados
% % sensores_a_cargar=5;
% cantidad_de_sensores_titulo='5';
% simulaciones_a_cargar=[12 7 22 27];
...
% save(['primera_grafica_' cantidad_de_sensores_titulo '_sensores_clusters_fijados=' clusters_fijados '.mat']);
% cd ..
...
% % % % 1 para 2 sensores, 2 para 5 sensores, 3 para 10 sensores
% % % % 4 para 20 sensores, 5 para 50 sensores
for cantidad_de_sensores_titulo=[50]
...
load(['primera_grafica_' cantidad_de_sensores_titulo '_sensores_clusters_fijados=' clusters_fijados '.mat']);
% cantidad_de_sensores=num2str(cantidad_de_sensores);

counter=0;
XtickFiguras=['1';'2';'3';'4'];
...
title([cantidad_de_sensores_titulo ' sensores, isotrópica, clusters: ' clusters_fijados ', \it\theta = 45º, \phi = 0º'],'FontSize',14);xlabel('Casos de estudio','FontSize',14);ylabel('Eficiencia','FontSize',14);set(gca,'XtickLabel',XtickFiguras,'FontSize',14,'XLim',eje_X);
...
title([cantidad_de_sensores_titulo ' sensores, dipolo, clusters: ' clusters_fijados ', \it\theta = 45º, \phi = 0º'],'FontSize',14);xlabel('Casos de estudio','FontSize',14);ylabel('Eficiencia','FontSize',14);set(gca,'XtickLabel',XtickFiguras,'FontSize',14,'XLim',eje_X);
...
title([cantidad_de_sensores_titulo ' sensores, isotrópica, clusters: ' clusters_fijados ', \it\theta = 45º, \phi = 45º'],'FontSize',14);xlabel('Casos de estudio','FontSize',14);ylabel('Eficiencia','FontSize',14);set(gca,'XtickLabel',XtickFiguras,'FontSize',14,'XLim',eje_X);
...
title([cantidad_de_sensores_titulo ' sensores, dipolo, clusters: ' clusters_fijados ', \it\theta = 45º, \phi = 45º'],'FontSize',14);xlabel('Casos de estudio','FontSize',14);ylabel('Eficiencia','FontSize',14);set(gca,'XtickLabel',XtickFiguras,'FontSize',14,'XLim',eje_X);
set(1,'Color',[1 1 1])
...
counter=counter+1;figura(counter)=figure;
subplot(2,2,1);bar(eficiencia_phi1_iso);hold on;plot(eje_X,[1 1],'k');plot(1:length(eficiencia_phi1_iso(:,1)),mean(eficiencia_phi1_iso,2),'r','LineWidth',2);hold off;grid on;
title([cantidad_de_sensores_titulo ' sensores, isotrópica, \it\theta = 45º, \phi = 0º']);xlabel('Casos de estudio');ylabel('Eficiencia');set(gca,'XtickLabel',XtickFiguras);%axis([0.5 length(eficiencia_5_iso_estacion_1(:,1))+0.5 0 20]);
subplot(2,2,2);bar(eficiencia_phi1_dip);hold on;plot(eje_X,[1 1],'k');plot(1:length(eficiencia_phi1_dip(:,1)),mean(eficiencia_phi1_dip,2),'r','LineWidth',2);hold off;grid on;
title([cantidad_de_sensores_titulo ' sensores, dipolo, \it\theta = 45º, \phi = 0º']);xlabel('Casos de estudio');ylabel('Eficiencia');set(gca,'XtickLabel',XtickFiguras);%axis([0.5 length(eficiencia_5_iso_estacion_1(:,1))+0.5 0 20]);
subplot(2,2,3);bar(cluster_phi1_iso);
title('Clusters: Isotrópica');xlabel('Casos de estudio');ylabel('Clusters');set(gca,'XtickLabel',XtickFiguras);%axis([0.5 length(eficiencia_5_iso_estacion_1(:,1))+0.5 0 20]);%axis([1 length(eficiencia_phi2_iso(:,1))+0.3 0 max(max(eficiencia_phi1_iso))+0.3]);
subplot(2,2,4);bar(cluster_phi1_dip);
title('Clusters: Dipolo');xlabel('Casos de estudio');ylabel('Clusters');set(gca,'XtickLabel',XtickFiguras);%axis([0.5 length(eficiencia_5_iso_estacion_1(:,1))+0.5 0 20]);%axis([1 length(eficiencia_phi2_iso(:,1))+0.3 0 max(max(eficiencia_phi1_iso))+0.3]);
...
title([cantidad_de_sensores_titulo ' sensores, isotrópica, \it\theta = 45º, \phi = 45º']);xlabel('Casos de estudio');ylabel('Eficiencia');set(gca,'XtickLabel',XtickFiguras);%axis([0.5 length(eficiencia_5_iso_estacion_1(:,1))+0.5 0 20]);
...
title([cantidad_de_sensores_titulo ' sensores, dipolo, \it\theta = 45º, \phi = 45º']);xlabel('Casos de estudio');ylabel('Eficiencia');set(gca,'XtickLabel',XtickFiguras);%axis([0.5 length(eficiencia_5_iso_estacion_1(:,1))+0.5 0 20]);
