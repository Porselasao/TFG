...
%     title(titulo)
    set(P, 'Visible', 'off')
    hold on
    polar(t(1:end),[Etot{c_antenas,c_sensor,c_phi,c_theta,i,1}(vector_thetas(c_theta),:) Etot{c_antenas,c_sensor,c_phi,c_theta,i,1}(vector_thetas(c_theta),1)]);
    hold on
    polar(t(1:end),[Etot1{c_antenas,c_sensor,c_phi,c_theta,i,1}(vector_thetas(c_theta),:) Etot1{c_antenas,c_sensor,c_phi,c_theta,i,1}(vector_thetas(c_theta),1)],'r');
