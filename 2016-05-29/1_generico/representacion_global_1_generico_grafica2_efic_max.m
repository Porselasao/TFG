...
for num=simulaciones_a_cargar
    for ejecucion=1:cantidad_realizaciones
        ...
        if(exist(caso_a_cargar,'file'))
            ...
            eficiencia_phi1_iso(contador_archivo,ejecucion)=max(Tiempo_de_vida_beam{1,1,c_phi1,1,1})./max(Tiempo_de_vida_beam1{1,1,c_phi1,1,1});
            eficiencia_phi2_iso(contador_archivo,ejecucion)=max(Tiempo_de_vida_beam{1,1,c_phi2,1,1})./max(Tiempo_de_vida_beam1{1,1,c_phi2,1,1});
            eficiencia_phi1_dip(contador_archivo,ejecucion)=max(Tiempo_de_vida_beam{2,1,c_phi1,1,1})./max(Tiempo_de_vida_beam1{2,1,c_phi1,1,1});
            eficiencia_phi2_dip(contador_archivo,ejecucion)=max(Tiempo_de_vida_beam{2,1,c_phi2,1,1})./max(Tiempo_de_vida_beam1{2,1,c_phi2,1,1});
