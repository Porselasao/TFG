...
% Introduzco la posición de los sensores
    ...
    amplitud1{c_antenas,c_sensores,instante}=20*log10(sum(sqrt(array_resultado{c_antenas,c_sensores,instante}(1,5,1:Numero_de_sensores)))^2/Numero_de_sensores^2);
