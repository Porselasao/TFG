...
titulo_grafica=', 3 estaciones base y 2 nodos enemigos';
...
XtickFiguras=['Estación base 1';'Estación base 2';'Estación base 3';'Nodo enemigo 1 ';'Nodo enemigo 2 '];
counter=0;
...
title(['20 sensores, 3D, carga aleatoria ' titulo_grafica],'FontSize',14);ylabel('Eficiencia','FontSize',14);set(gca,'XtickLabel',XtickFiguras,'FontSize',14);
...
title(['50 sensores, 3D, carga aleatoria ' titulo_grafica],'FontSize',14);ylabel('Eficiencia','FontSize',14);set(gca,'XtickLabel',XtickFiguras,'FontSize',14);
