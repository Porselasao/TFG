...
for i=1:Numero_de_cluster
    ...
    if estacion_si
        for j=1:length(estacion(:,1))
            ...
            [directivity_dBi,Thmax,Phmax,directivity_dBi_buscada] = Calcula_Directividad(array_config(:,:,idx==i),freq_config,range_config,deltheta,delphi,theta_cluster,phi_cluster);
