...
titulo_grafica=', 1 estación base y 5 nodos enemigos';
XtickFiguras=['Estación base 1';'  N. enemigo 1 ';'  N. enemigo 2 ';'  N. enemigo 3 ';'  N. enemigo 4 ';'  N. enemigo 5 '];
counter=0;
...
title(['10 sensores, isotrópica, 3D, carga aleatoria ' titulo_grafica],'FontSize',14);ylabel('Eficiencia','FontSize',14);set(gca,'XtickLabel',XtickFiguras,'FontSize',14);
...
title(['20 sensores, isotrópica, 3D, carga aleatoria ' titulo_grafica],'FontSize',14);ylabel('Eficiencia','FontSize',14);set(gca,'XtickLabel',XtickFiguras,'FontSize',14);
...
title(['50 sensores, isotrópica, 3D, carga aleatoria ' titulo_grafica],'FontSize',14);ylabel('Eficiencia','FontSize',14);set(gca,'XtickLabel',XtickFiguras,'FontSize',14);
