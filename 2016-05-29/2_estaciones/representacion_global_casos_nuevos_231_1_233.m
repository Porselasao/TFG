...
titulo_grafica='Elección entre 5 estaciones base';
...
title([titulo_grafica ', 3D, carga aleatoria'],'FontSize',14);xlabel('Sensores','FontSize',14);ylabel('Eficiencia','FontSize',14);set(gca,'XtickLabel',XtickFiguras,'FontSize',14);
set(1,'Color',[1 1 1])
